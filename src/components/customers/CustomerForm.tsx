		...
		<Sheet open={isOpen} onOpenChange={handleClose}>
			<SheetContent
				...
				className={`flex flex-col p-0 ${
					isDesktop ? "w-[500px] sm:max-w-[500px]" : "h-[90vh]"
				}`}
			>
				{/* Header with proper spacing and dark mode */}
				...
				{/* Scrollable Content with margins */}
				<ScrollArea className="min-h-0 flex-1">
					<div className="px-6 py-6">
						<form onSubmit={handleSubmit} className="space-y-6">
							{/* Customer Preview Card with semantic colors */}
							{customerInsights && (
								<div className="rounded-lg border bg-gradient-to-r from-blue-50 to-indigo-50 p-4 dark:border-blue-900/50 dark:from-blue-950/30 dark:to-indigo-950/30">
				...
				{/* Sticky Footer Actions with proper spacing */}
				<div
